              ...
              {isAuthenticated && user ? (
                <div className="flex items-center space-x-4">
                   ...
                   {user.role === UserRole.MODERATOR && (
                    <Link to="/panel"><Button variant="secondary" className="px-3 py-1.5 text-xs h-8">Panel</Button></Link>
                   )}
      ...
      <footer className="border-t border-gray-800 bg-[#0f0f10] py-12">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul className="space-y-2 text-sm text-gray-500">
                    <li><a href="https://discord.gg/dWSyuYPv4K" target="_blank" rel="noopener noreferrer" className="hover:text-amber-500">Discord</a></li>
